...
import prefect_spark_on_k8s_operator

COLLECTION_SLUG = "prefect_spark_on_k8s_operator"
...
for _, module_name, ispkg in iter_modules(prefect_spark_on_k8s_operator.__path__):
...
with mkdocs_gen_files.open(examples_catalog_path, "w") as generated_file:
    generated_file.write(
        dedent(
            ...
            Below is a list of examples for `prefect-spark-on-k8s-operator`.
            """
        )
    )
